    ...
    return (
        <View style={styles.main}>
            <View style={{
                ...
                <Image source={{ uri: 'https://firebasestorage.googleapis.com/v0/b/react-9b3c2.appspot.com/o/hotel.jpg?alt=media&token=db1b99c6-225b-4f8f-a306-d7d3ed36303f' }}
                    style={{
                        width: '100%',
                        height: 300,
                    }}
...
<View style={styles.whatsapp}>
                    <TouchableOpacity onPress={() => (
                        Linking.openURL("whatsapp://send?phone+234 8100652910=+234 9078257786&text=Hi good day i want to verify the Portrait at Nwaniba Road By  Le-meridian Hotel Junction Uyo")
                    )}>
