        ...
        <View style={styles.main}>
            ...
            <View style={styles.Total}>
                ...
                <Text style={{ marginLeft: 10, fontSize: 23, fontWeight: '300', marginTop: 6 }}>
                    Ibb Oposite Ibom Hall Uyo, Akwa Ibom
                </Text>
                <View style={styles.buttons}>
                    <View style={styles.whatsapp}>
                        <TouchableOpacity onPress={() => (
                            Linking.openURL("whatsapp://send?phone=+234 8100652910&text=Hi good day i want to verify the 48 Sheet at Ibb Oposite Ibom Hall Uyo")
                        )}>
