        ...
        <View style={styles.main}>
            ...
            <View style={{
                ...
                <Text style={{ marginLeft: 10, fontSize: 23, fontWeight: '300', marginTop: 6 }}>
                    Abak Road By Qua Ibo Church Uyo, Akwa Ibom
                </Text>
          ...
          <Text style={{ fontWeight: 'bold' }}>Available</Text>
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => (
                        Linking.openURL("whatsapp://send?phone=+234 8100652910&text=Hi good day i want to verify the 48 Sheet at Abak Road By Qua Ibo Church Uyo")
                    )}>
                        <View style={{
                            width: 360,
                            height: 50,
