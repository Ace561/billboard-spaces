    ...
    return (
        <View style={styles.main}>
            <View style={{
                ...
                <Image source={{uri:'https://firebasestorage.googleapis.com/v0/b/react-9b3c2.appspot.com/o/hhh.jpg?alt=media&token=d683f02b-1475-4595-8256-3fbe185ed766'}}
                    style={{
                        width: '100%',
                        height: 250,
                        // resizeMode:'contain'
            ...
            <View style={{
                ...
                <Text style={{ marginLeft: 10, fontSize: 23, fontWeight: '300', marginTop: 6 }}>
                    Aka Obot Idem  After Nung Udo Ibesikpo Asutan, Eket Road, Akwa Ibom
                </Text>
          ...
          <Text style={{ fontWeight: 'bold' }}>Unavailable</Text>
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => (
                        Linking.openURL("whatsapp://send?phone=+234 8100652910&text=Hi good day i want to verify the 48 Sheet at Aka Obot Idem  After Nung Udo Ibesikpo Asutan, Eket Road")
                    )}>
                        <View style={{
                            width: 360,
                            height: 50,
