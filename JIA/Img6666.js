  ...
  return (
    <View style={styles.main}>
      <View style={{
        ...
        <Image source={{uri:'https://firebasestorage.googleapis.com/v0/b/react-9b3c2.appspot.com/o/6666.jpg?alt=media&token=bc0f416b-371e-4c97-9594-d838d743acfb'}}
          style={{
            width: '100%',
            height: 200,
            // resizeMode:'contain'
      ...
      <View style={{
        ...
        <Text style={{ marginLeft: 10, fontSize: 23, fontWeight: '300', marginTop: 6 }}>
          Calabar Itu Road Befor Health Center Uyo, Akwa Ibom        </Text>
