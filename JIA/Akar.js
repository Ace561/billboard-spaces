    ...
    return (
        <View style={styles.main}>
            <View style={{
                ...
                <Image source={require('../assets/akaRoad.jpg')}
                    style={{
                        width: '100%',
                        height: 200,
                        // resizeMode:'contain'
          ...
          <Text style={{ fontWeight: 'bold' }}>Available</Text>
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => (
                        Linking.openURL("whatsapp://send?phone=+234 8100652910&text=Hi good day i want to verify the Unipole at Abak Road By Fedral Secretariat After Plaza Uyo")
                    )}>
                        <View style={{
                            width: 360,
                            height: 50,
