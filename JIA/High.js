    ...
    return (
        <View style={styles.main}>
            ...
            <View style={{
                ...
                Calabar Itu Highway After Itam Market Uyo, Akwa Ibom
                </Text>
          ...
          <Text style={{ fontWeight: 'bold' }}>Available</Text>
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => (
                        Linking.openURL("whatsapp://send?phone=+234 8100652910&text=Hi good day i want to verify the 48 Sheet at Calabar Itu Highway After Itam Market Uyo")
                    )}>
                        <View style={{
                            width: 360,
                            height: 50,
