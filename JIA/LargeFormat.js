import { StyleSheet, Text, View, TouchableOpacity, ScrollView, RefreshControl, Image, Button, ActivityIndicator, Modal } from 'react-native'
...
export default function Portrait({ navigation }) {
    ...
    useEffect(() => {
        ...
        const databaseRef = ref(database, 'largeFormat');
    ...
    const seeAll = (location) => {
        ...
        navigation.navigate('Large format', { state: location });
        // ...
    };
