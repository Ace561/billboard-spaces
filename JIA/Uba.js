    ...
    return (
        <View style={styles.main}>
            ...
            <View style={{
                ...
                Ikot Ekpene Uyo Road By Uba Pimary School Uyo, Akwa Ibom
                </Text>
          ...
          <Text style={{ fontWeight: 'bold' }}>Available</Text>
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => (
                        Linking.openURL("whatsapp://send?phone=+234 8100652910&text=Hi good day i want to verify the 48 Sheet at Ikot Ekpene Uyo Road By Uba Pimary School Uyo")
                    )}>
                        <View style={{
                            width: 360,
                            height: 50,
