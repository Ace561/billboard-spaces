    ...
    return (
        <View style={styles.main}>
            <View style={{
                ...
                <Image source={{ uri: 'https://firebasestorage.googleapis.com/v0/b/react-9b3c2.appspot.com/o/abak.jpg?alt=media&token=c7cdfc68-f0e6-4969-bc4b-4981e3b66647' }}
                    style={{
                        width: '100%',
                        height: 200,
                        // resizeMode:'contain'
                ...
                <View style={styles.buttons}>
                    <View style={styles.whatsapp}>
                        <TouchableOpacity onPress={() => (
                            Linking.openURL("whatsapp://send?phone=+234 8100652910&text=Hi good day i want to verify the Unipole at Abak Uyo Road After Ekom Iman Flyover (Obasanjo Road) Uyo")
                        )}>
