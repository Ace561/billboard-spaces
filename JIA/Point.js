    ...
    return (
        <View style={styles.main}>
            ...
            <View style={{
                ...
                Abak Road By 4 Point After Ikot Ekpene Plaza Uyo, Akwa Ibom
                </Text>
          ...
          <Text style={{ fontWeight: 'bold' }}>Available</Text>
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => (
                        Linking.openURL("whatsapp://send?phone=+234 8100652910&text=Hi good day i want to verify the 48 Sheet at Abak Road By 4 Point After Ikot Ekpene Plaza Uyo")
                    )}>
                        <View style={{
                            width: 360,
                            height: 50,
