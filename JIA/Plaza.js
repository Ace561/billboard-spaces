    ...
    return (
        <View style={styles.main}>
            <View style={{
                ...
                <Image source={{uri:'https://firebasestorage.googleapis.com/v0/b/react-9b3c2.appspot.com/o/oando.jpg?alt=media&token=0919350a-de0b-40b5-a4d2-c27848f291d9'}}
                    style={{
                        width: '100%',
                        height: 250,
                        // resizeMode:'contain'
            ...
            <View style={{
                ...
                Ibom Plaza By Oando Station Oron Road Uyo, Akwa Ibom
                </Text>
          ...
          <Text style={{ fontWeight: 'bold' }}>Available</Text>
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => (
                        Linking.openURL("whatsapp://send?phone=+234 8100652910&text=Hi good day i want to verify the 48 Sheet at Ibom Plaza By Oando Station Oron Road Uyo")
                    )}>
                        <View style={{
                            width: 360,
                            height: 50,
